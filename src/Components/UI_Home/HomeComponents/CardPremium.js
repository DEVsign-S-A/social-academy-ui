	...
	return (
		<div className="CardsPremiumIndividuales">
			<div className="IndividualesSuperior">
				<div className="IndividualesLinea"></div>
				...
				<img
					className="CardSemicirculo"
					src={`https://res.cloudinary.com/socialacademy/image/upload/v1630603834/Social%20Academy%20Image/HomeScreen/ArcoCardPremium_n8aujz.png`}
					alt="Arco Rosa"
				/>
			</div>
			<div className="IndividualesTextoPrecio ">
				...
				<div className="TextoPrecio2">
					<h2 className="text-white font-bold">{precio}</h2>
				</div>
				<div className="TextoPrecio3">
					<h3 className="text-white font-bold">/M</h3>
				</div>
			</div>
			...
			<div className="IndividualesInferior">
				<div className="InferiorImagen">
					<img
						src={`https://res.cloudinary.com/socialacademy/image/upload/v1630603833/Social%20Academy%20Image/HomeScreen/SemicirculoCardPremium_yc8bre.png`}
						alt="Semicirculo Rosa"
					/>
				</div>
				<div className="InferiorBoton">
					<Link to="/Login" className="BotonPremium pointer">
						Obtener
					</Link>
				</div>
			</div>
