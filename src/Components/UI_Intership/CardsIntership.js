...
export const CardsIntership = ({
	...
	const { fotoPerfil, nombreEmpresa, direccion, sectorComercial } = EmpresaInfo;
	...
	const content = (
		<div>
			...
			<a onClick={viewEnterprise}>Ver perfil</a>
		</div>
	);
			...
			<div className="bg-gray-50 mx-3 my-8 rounded-xl shadow-lg ring-1 ring-gray-200 singleCardInternship">
				<div className="m-3">
					...
					<div className="w-full flex justify-center items-center">
						...
						>
							<img
								className="w-16 h-16 rounded-full ring-4 ring-gray-300"
								src={fotoPerfil}
								alt={nombreEmpresa}
							/>
						</Popover>
